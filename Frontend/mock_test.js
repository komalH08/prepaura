...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function generateAndShowFinalReport(reason) {
        ...
        try {
            const response = await fetch("https://prepmate-backend-bpfn.onrender.com/generate-final-report", {
                method: "POST",
    ...
    async function sendInterviewAnswer(audioBlob, expressionsJSON) {
        ...
        try {
            const response = await fetch(`https://prepmate-backend-bpfn.onrender.com${endpoint}`, {
                method: "POST",
                body: formData, 
            });
